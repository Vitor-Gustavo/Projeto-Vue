<template>
  <v-container class="pa-8" fluid>
    ...
    <v-form>
      <v-container>
        <v-text-field color="black" label="Nome" v-model="nome"></v-text-field> 
        <v-text-field color="black" label="Sobrenome" v-model="sobrenome"></v-text-field>
        <v-btn color="black" dark @click="salvarPerfil">Salvar</v-btn>
      </v-container>
    </v-form>
  </v-container>
</template>
